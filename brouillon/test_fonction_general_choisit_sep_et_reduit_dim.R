...
source("brouillon/fonction_general_choisit_sep_et_reduit_dim.R",encoding = "UTF-8")
...
### Test dimension 5
# format ne marche pas encore en 5 dimensions :)
...
res5_4 <- gen_tabs_5_4_to_3(dfs,nom_dfs,totcode ,hrcfiles)
