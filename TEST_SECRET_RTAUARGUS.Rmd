...
2 stats_1table D               211  67280525.      30.6        21.9
3 stats_1table V               134 184363000.      19.4        59.9

  METHODE     statut_final n_cell   val_cell pc_n_cell pc_val_cell
  <chr>       <chr>         <int>      <dbl>     <dbl>       <dbl>
1 stats_liste A               344  56105487.      49.9        18.2
2 stats_liste D               194  78130258.      28.2        25.4
3 stats_liste V               151 173513267.      21.9        56.4
...
2 stats_liste40 D               220  84733605.      31.9        27.5
3 stats_liste40 V               193 190639013.      28          61.9

 METHODE        statut_final n_cell   val_cell pc_n_cell pc_val_cell
  <chr>          <chr>         <int>      <dbl>     <dbl>       <dbl>
1 stats_1table40 B               276  32376395.      40.1        10.5
2 stats_1table40 D               223  57667638.      32.4        18.7
3 stats_1table40 V               190 217704980.      27.6        70.7
...
2 stats_1table30 D               261  45817363.      37.9        14.9
3 stats_1table30 V               221 246309859.      32.1        80

  METHODE       statut_final n_cell   val_cell pc_n_cell pc_val_cell
  <chr>         <chr>         <int>      <dbl>     <dbl>       <dbl>
1 stats_liste30 A               207  15621791.      30           5.1
2 stats_liste30 D               239  61434618.      34.7        20  
3 stats_liste30 V               243 230692603.      35.3        75  
### On pose le primaire
...
2 stats_liste20 D               298  57706204.      43.3        18.8
3 stats_liste20 V               253 243172664.      36.7        79  
...
On observe qu' il n'y a pas une très grande différence de secret même si la liste de tableaux à tendance à sursecrétisé et cela se voit notamment vu la taille de la liste .
On peut néanmoins remarquer une certaine tendance , cette tendance est que les listes de tables perdent un peu en valeurs importantes et elles semblent avoir plus de secret secondaire.

Car on avait vu dans le teste à 0 hiérarchie que les données à 4 variables catégorielles que tau argus avec la méthode de mettre directement les tableaux est plus eficace sur les petites tables .
