...
|-----------------|-------------------|--------------------------|--------------------|
| Min             | 2                 | 985,320                  | 2.34 sec           |    
| Max             | 492               | 5,328                    | 119.52 sec         |  
| Smart (50,000)  | 82                | 27,328                   | 40.09 sec          |
...
L'option "smart" est plus rapide dans la réduction de dimension lorsqu'elle
permet d'éviter au moins 40 ou 50 tableaux par rapport au max.
...
| Méthode         | nombre de tableau | nombre de ligne maximale | Temps de réduction   | 
|-----------------|-------------------|--------------------------|----------------------|
| Min             | 2                 | 16,563,690               | 19.31 sec            |  
| Max             | 1404              | 30,288                   | > 20min (estimation) |  
...
Pour l'estimation : 
le cas min a pris environ 9min par tableau;
le cas smart a pris 4 min par tableau; 
(tableaux 65 fois moins long au maximum et réduction par 2 du temps par tableau)

dans en étant optimiste (1sec par tableau), le cas max prendrait 23min.
(tableau 8 fois moins long au maximum par rapport au cas "smart")