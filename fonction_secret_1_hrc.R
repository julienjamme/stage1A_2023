...
test_part_secret1H <-function(data, quant){
  ...
  totcodes <- c(treff="Total",cj="Total", ACTIVITY  ="Total",nuts1="Total")
  
  root_dir <- "test_avec_rtauargus/hierarchie_2/1/mod"
