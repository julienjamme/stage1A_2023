...
Le but de ce test est de savoir quand est ce que l'on peut utiliser rtauargus quand on a une table a 4 dimension .En outre, on essayera de comparer les différents résultats avec une petite table (res_all_dtp de 679 lignes ) et ensuite une grande table de 14890 lignes .
...
t<-toc()
```
Le programme se lance néanmoins hypercube ne fonctionne pas. La console R affiche cette erreur :

--- Current table to treat:  table_test_0_hrc1 ---
Error in batch file
Avis : cannot open file 'test_avec_rtauargus/hierarchie_2/0/hypercube/table_test_0_hrc1.csv': No such file or directoryError in file(file, "rt") : cannot open the connection

et le dossier text de tauargus dis :
19-juil.-2023 10:10:48 : Start of the hypercube protection for table type_distrib x A10 x treff_cj | pizzas_tot
19-juil.-2023 10:10:49 : Unable to write the file TABELLE for the Hypercube
19-juil.-2023 10:10:49 : Error in batch file
19-juil.-2023 10:10:49 : End of TauArgus run
...
|--------------|--------|-------------|------------|-------------|-----------|----------|
| A            | 79     | 2,172,240   | 11.465893  | 0.7058516   | liste de  | 322.44 s |
...
Cependant dès que l'on passe à des grandes tables, 
il semblerait que la méthode de faire une liste de tableaux est plus perfomantes.
Le but serait alors de trouver un certain seuil ou tau argus fonctionne et pour lequel la liste de tableaux devient plus efficace que tauargus sur une table directement. On peut penser que le warning de tauargus quand il y a 4 dimensions y est pour quelque chose
